...
function innerTextFn() {
  ...
  const data = [
    chapters[2].example,  // 0
    chapters[2].example, // 1
    chapters[2].example, // 2
    chapters[2].example1, // 3
    chapters[2].example1, // 4
    chapters[2].example1, // 5
    chapters[2].example2, // 6
    chapters[2].example2, // 7
    chapters[2].example2,  // 8
    chapters[2].example1, // 3
    chapters[2].example1, // 4
    chapters[2].example1, // 5
    chapters[2].example2, // 6
