...
function innerTextFnBackward()
{
  ...
  const updatedArraydozabar = chldSet0.map(letter => letter + dozabar);
  const chldSet6 = updatedArraydozabar;
  //chapters[3].chapter;
  const headSet7 = chapters[3].data4;
  const updatedArraydozer = chldSet0.map(letter => letter + dozer);
  const chldSet7 = updatedArraydozer;
  //chapters[3].chapter1;
  const headSet8 = chapters[3].data7;
  const updatedArraydopesh = chldSet0.map(letter => letter + dopesh);
  const chldSet8 = updatedArraydopesh; 
  //chapters[3].chapter2;
  var array=[chldSet0,chldSet,chldSet1,chldSet2,chldSet3,chldSet4,chldSet5,chldSet6,chldSet7,chldSet8];
  var arrayh=[headSet0,headSet,headSet1,headSet2,headSet3,headSet4,headSet5,headSet6,headSet7,headSet8];
